...
import { Sparkles, DollarSign, ShoppingBag, TrendingUp, RefreshCw, Layers, Calendar, BarChart3, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div className="glass-panel px-5 py-4 rounded-xl flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="xl:col-span-2 space-y-6 flex flex-col">
          {/* Revenue chart */}
          <div className="glass-panel p-6 rounded-2xl flex-1 flex flex-col justify-between min-h-[340px]">
            <div>
        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between relative overflow-hidden min-h-[400px]">
          {/* Neon Glow backdrop */}
